...
public class ProgramProcessInfoModel {
	...
	String proc_id;
	String proc_nm;
	String tightening_proc_status;  
	String device_id;
	String device_serial;
	String reconnect_waiting_sec; 
	String logical_trk_flg;
	String interlock_use_flg; 
	String interlock_ng_point;
	String interlock_ng_cnt;
	String interlock_noscan_point;
	String interlock_noscan_cnt;
	String trk_plc_type;
	String trk_plc_ip;
	String trk_plc_port;
	String trk_plc_start_add; 
	String interlock_plc_type;
	String interlock_plc_ip;
	String interlock_plc_port;
	...
	String ng_trk_point;
	String ng_trk_view_cnt;
	String ng_trk_alarm_point; 
	...
	public String getTightening_proc_status() {
		return tightening_proc_status;
	}
	public void setTightening_proc_status(String tightening_proc_status) {
		this.tightening_proc_status = tightening_proc_status;
	}
	...
	public String getReconnect_waiting_sec() {
		return reconnect_waiting_sec;
	}
	public void setReconnect_waiting_sec(String reconnect_waiting_sec) {
	...
	public void setInterlock_use_flg(String interlock_use_flg) {
		this.interlock_use_flg = interlock_use_flg;
	}
	public String getInterlock_ng_point() {
		return interlock_ng_point;
	}
	public void setInterlock_ng_point(String interlock_ng_point) {
		this.interlock_ng_point = interlock_ng_point;
	}
	public String getInterlock_ng_cnt() {
		return interlock_ng_cnt;
	}
	public void setInterlock_ng_cnt(String interlock_ng_cnt) {
		this.interlock_ng_cnt = interlock_ng_cnt;
	}
	public String getInterlock_noscan_point() {
		return interlock_noscan_point;
	}
	public void setInterlock_noscan_point(String interlock_noscan_point) {
		this.interlock_noscan_point = interlock_noscan_point;
	}
	public String getInterlock_noscan_cnt() {
		return interlock_noscan_cnt;
	}
	public void setInterlock_noscan_cnt(String interlock_noscan_cnt) {
	...
	public String getTrk_plc_ip() {
		return trk_plc_ip;
	}
	public void setTrk_plc_ip(String trk_plc_ip) {
		this.trk_plc_ip = trk_plc_ip;
	}
	public String getTrk_plc_port() {
		return trk_plc_port;
	}
	public void setTrk_plc_port(String trk_plc_port) {
		this.trk_plc_port = trk_plc_port;
	}
	public String getTrk_plc_start_add() {
		return trk_plc_start_add;
	}
	public void setTrk_plc_start_add(String trk_plc_start_add) {
	...
	public String getInterlock_plc_port() {
		return interlock_plc_port;
	}
	public void setInterlock_plc_port(String interlock_plc_port) {
	...
	public String getTrk_point() {
		return trk_point;
	}
	public void setTrk_point(String trk_point) {
		this.trk_point = trk_point;
	}
	public String getTrk_stn_cnt() {
		return trk_stn_cnt;
	}
	public void setTrk_stn_cnt(String trk_stn_cnt) {
	...
	public String getNg_trk_point() {
		return ng_trk_point;
	}
	public void setNg_trk_point(String ng_trk_point) {
		this.ng_trk_point = ng_trk_point;
	}
	public String getNg_trk_view_cnt() {
		return ng_trk_view_cnt;
	}
	public void setNg_trk_view_cnt(String ng_trk_view_cnt) {
		this.ng_trk_view_cnt = ng_trk_view_cnt;
	}
	public String getNg_trk_alarm_point() {
		return ng_trk_alarm_point;
	}
	public void setNg_trk_alarm_point(String ng_trk_alarm_point) {
