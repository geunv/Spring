...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		//console.log( "1.document loaded :" , Date.now()-timerStart );
    ...
    $( window ).on( "load", function() {
    	//document.getElementById('load-image').style.display = "block";
        //console.log( "2.window loaded :", Date.now()-timerStart );
...
<div class="container">
	<div id="C_Body">       
        ...
        <input type="hidden" id="BODY_VAL">
        <input type="hidden" id="TOR_VAL">
        <input type="hidden" id="ANG_VAL">
