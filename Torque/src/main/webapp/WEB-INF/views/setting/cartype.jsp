...
if('U' == '<%=user_grade%>'){
    ...
    function getList(){
    	...
    	$.get('/api/setting/getcartypelist'+params,function(data){
    		if(data.result == 200){
    	...
    	$.ajax({
    			...
    			success: function(data) {
    				if(data.result == 200){
    					...
    					$("#list_excel").append("<th><spring:message code='ST03.Code'/></th>");
						$("#list_excel").append("<th><spring:message code='ST03.CodeName'/></th>");
    ...
    function OpenRegistration(CodeGrp, Code) {
        var title = '<spring:message code="SCREEN.ST03" />';
        fn_ShowDialog('/view/setting/cartypeP01?code_grp=' + $.trim(CodeGrp) + '&code=' + $.trim(Code), title, '500', '300', true);
    }
	...
	<div id="C_Body">       
        <div id="C_Title">
            <div id="content-title">
                <i class="fa fa-pencil-square-o "></i> <spring:message code="SCREEN.ST03"/><!-- <asp:Label ID="lblTitle" runat="server" Text="SCREEN.ST03"></asp:Label> -->
            </div>
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td width="7%" bgcolor="#FFFFFF" class="left_5">
                                    <i class="fa fa-chevron-circle-right"></i>&nbsp; <spring:message code="ST03.Code"/><!-- <asp:Label ID="lblCode" runat="server" Text="ST03.Code"></asp:Label> -->
                                </td>
                                <td width="15%" class="left_5" >
        ...
        <div id="C_Result" style="overflow:auto;">
           <div class="total_count">
	        	...
	        	<table class="gridview" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;" id="list_table">
	            	<thead>
						<tr>
					        ...
					        <th style="width:10%"><div align="center"><spring:message code="ST03.Code"/></div></th>
					        <th style="width:40%"><div align="center"><spring:message code="ST03.CodeName"/></div></th>
					        <th style="width:20%"><div align="center"><spring:message code="ST03.CodeValue"/></div></th>
        	...
        	<div id="wrapper" style="visibility:hidden;overflow:hidden;height:0px;">
        		<input type="text" id="txtCodeGrp" value="CARTYPE"/>
