...
$(document).ready(function(){
    ...
    $("#btnClose").click(function(e) {
		...
		function ValidationCheck(e, flag) {
            if ($("#txtCode").val() == "") {
                e.preventDefault();
                var retVal = '<spring:message code="ST03.EnterCode"/>';
...
function fn_save(){
	...
	$.ajax({
		type : "POST",
		url : '/api/setting/cartype_insert',
...
function fn_modify(){
	...
	$.ajax({
		type : "PUT",
		url : '/api/setting/cartype_update',
		data : JSON.stringify(body),
		headers: { 
			'Accept': 'application/json',
			'Content-Type': 'application/json' 
...
function fn_delete(){
	...
	$.ajax({
		type : "DELETE",
		url : '/api/setting/cartype_delete'+params,
	}).done(function(result) {
		//console.log(result);
		if(result.result == 200){
			var retVal = '<spring:message code="COMMON.Success"/>';
    ...
    <div class="panel">
        <div>
            <table width="100%" align="center" class="table table-bordered">
                    ...
                    <tr>
                        <td class="td-title"><spring:message code="ST03.Code"/><!-- <asp:Label ID="lblCode" runat="server" Text="ST03.Code"></asp:Label> --></td>
                        <td><input type="text" id="txtCode"><!-- <asp:TextBox ID="txtCode" runat="server" ></asp:TextBox> --></td>
                    </tr>
                    <tr>
                        <td class="td-title"><spring:message code="ST03.CodeName"/><!-- <asp:Label ID="lblCodeName" runat="server" Text="ST03.CodeName"></asp:Label> --></td>
                        <td><input type="text" id="txtCodeName"><!-- <asp:TextBox ID="txtCodeName" runat="server" ></asp:TextBox> --></td>
                    </tr>
                    <tr>
                        <td class="td-title"><spring:message code="ST03.CodeValue"/><!-- <asp:Label ID="lblCodeValue" runat="server" Text="ST03.CodeValue"></asp:Label> --></td>
                        <td><input type="text" id="txtCodeValue"><!-- <asp:TextBox ID="txtCodeValue" runat="server" ></asp:TextBox> --></td>
                    </tr>
            </table>
        </div>
        <div align="center">
