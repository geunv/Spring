...
$(document).ready(function(){
    ...
    $("#btnClose").click(function(e) {
		...
		function ValidationCheck(e, flag) {
            if ($("#txtCode").val() == "") {
                e.preventDefault();
                var retVal = '<spring:message code="ST06.EnterCode"/>';
    ...
    <div class="panel">
        <div>
            <table width="100%" align="center" class="table table-bordered">
                    ...
                    <tr>
                        <td class="td-title"><spring:message code="ST06.Code"/><!-- <asp:Label ID="lblCode" runat="server" Text="ST03.Code"></asp:Label> --></td>
                        <td><input type="text" id="txtCode"><!-- <asp:TextBox ID="txtCode" runat="server" ></asp:TextBox> --></td>
                    </tr>
                    <tr>
                        <td class="td-title"><spring:message code="ST06.CodeName"/><!-- <asp:Label ID="lblCodeName" runat="server" Text="ST03.CodeName"></asp:Label> --></td>
                        <td><input type="text" id="txtCodeName"><!-- <asp:TextBox ID="txtCodeName" runat="server" ></asp:TextBox> --></td>
                    </tr>
                    <%-- <tr>
                        <td class="td-title"><spring:message code="ST06.CodeValue"/></td>
