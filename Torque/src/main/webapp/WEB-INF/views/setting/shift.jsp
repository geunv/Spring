...
if('U' == '<%=user_grade%>'){
    ...
    function getList(){
    	...
    	$.get('/api/setting/shift_list'+params,function(data){
    		if(data.result == 200){
    ...
    function getExcelData(){
    	...
    	$.ajax({
    			url:'/api/setting/shift_list'+params,
    			type:'GET',
    			async:false,
    			success: function(data) {
    				if(data.result == 200){
    					...
    					$("#list_excel").append("<th><spring:message code='ST05.Code'/></th>");
						$("#list_excel").append("<th><spring:message code='ST05.CodeName'/></th>");
						$("#list_excel").append("<th><spring:message code='ST05.CodeValue'/></th>");
    					...
    					data.list.forEach(function(item){
    	    				...
    	    				$('#list_excel').append(
									...
									+ ' <td class="left_5">' + item.code_nm +'</td>'
									+ ' <td style=mso-number-format:"\@";>' + item.code_value +'</td>'
									+ ' <td>' + ChangeDateFormat(item.regdt) +'</td>'
									+ ' <td>' + item.reg_user_id +'</td>'
    	    					+ '</tr>'
    	    				);
    ...
    function OpenRegistration(CodeGrp, Code) {
        var title = '<spring:message code="SCREEN.ST05" />';
        fn_ShowDialog('/view/setting/shiftP01?code_grp=' + $.trim(CodeGrp) + '&code=' + $.trim(Code), title, '500', '300', true);
    }
	...
	<div id="C_Body">       
        <div id="C_Title">
            <div id="content-title">
                <i class="fa fa-pencil-square-o "></i> <spring:message code="SCREEN.ST05"/><!-- <asp:Label ID="lblTitle" runat="server" Text="SCREEN.ST03"></asp:Label> -->
            </div>
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td width="8%" bgcolor="#FFFFFF" class="left_5">
                                    <i class="fa fa-chevron-circle-right"></i>&nbsp; <spring:message code="ST05.Code"/>
                                </td>
                                <td width="15%" class="left_5" >
	        	...
	        	<table class="gridview" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;" id="list_table">
	            	<thead>
						<tr>
					        ...
					        <th style="width:10%"><div align="center"><spring:message code="ST05.Code"/></div></th>
					        <th style="width:40%"><div align="center"><spring:message code="ST05.CodeName"/></div></th>
					        <th style="width:20%"><div align="center"><spring:message code="ST05.CodeValue"/></div></th>
