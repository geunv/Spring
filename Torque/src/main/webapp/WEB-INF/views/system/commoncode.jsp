...
if('U' == '<%=user_grade%>'){
    ...
    $(document).ready(function() {
		...
		/* $("#txtCode").keydown(function (key) {
	    	if(key.keyCode == 13){//키가 13이면 실행 (엔터는 13)
	        	$('#btnSearch').click()
	        }
	    }); */
		
		$('#ddlCodeGrp').on('change', function(){
    		$('#btnSearch').click()
    	});
    ...
    function getList(){
    	...
    	var params = "?plant_cd="+$('#ddlPlant').val()+
    				 "&code_grp="+$('#ddlCodeGrp').val()+
    				 "&code="+$('#txtCode').val()+
    				 "&code_nm="+''+
    				 "&page="+now_page+
    				 "&show_count="+show_count;
    	
    	$.get('/api/system/getcommoncodelist'+params,function(data){
    		if(data.result == 200){
    			...
    			data.list.forEach(function(item){
    				...
    				$('#list_data').append(
    					   '<tr>'
							+ ' <td>' + item.rnum +'</td>'
							+ ' <td class="left_5">' + item.cd_grp +'</td>'
    ...
    function getExcelData(){
    	...
    	$.ajax({
    			url:'/api/system/getcommoncodelist'+params,
    			type:'GET',
    			async:false,
    			success: function(data) {
    				if(data.result == 200){
    					...
    					$("#list_excel").append("<th><spring:message code='SM02.CodeGrp'/></th>");
						$("#list_excel").append("<th><spring:message code='SM02.Code'/></th>");
						$("#list_excel").append("<th><spring:message code='SM02.CodeName'/></th>");
    					$("#list_excel").append("<th><spring:message code='SM02.CodeValue'/></th>");
    ...
    function OpenRegistration(CodeGrp, Code) {
    	var title = '<spring:message code="SCREEN.SM02" />';
        fn_ShowDialog('/view/system/commoncodeP01?code_grp=' + CodeGrp + '&code=' + Code, title, '500', '320', true);
    }
	...
	<div id="C_Body">       
        <div id="C_Title">
            <div id="content-title">
                <i class="fa fa-pencil-square-o "></i> <spring:message code="SCREEN.SM02"/><!-- <asp:Label ID="lblTitle" runat="server" Text="SCREEN.SM02"></asp:Label> -->
            </div>
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td  width="9%" bgcolor="#FFFFFF" class="left_5">
                                    <i class="fa fa-chevron-circle-right"></i>&nbsp; <spring:message code="SM02.CodeGrp"/><!-- <asp:Label ID="lblCodeGrp" runat="server" Text="SM02.CodeGrp"></asp:Label> -->
                                </td>
                                <td width="22%" class="left_5">
                                	<select id="ddlCodeGrp"></select>
                                    <!-- <asp:DropDownList ID="ddlCodeGrp" runat="server" AutoPostBack="true"
                                        onselectedindexchanged="ddlCodeGrp_SelectedIndexChanged"></asp:DropDownList> -->
                                </td>
                                <td width="5%" bgcolor="#FFFFFF" class="left_5">
                                    <i class="fa fa-chevron-circle-right"></i>&nbsp; <spring:message code="SM02.Code"/><!-- <asp:Label ID="lblCode" runat="server" Text="SM02.Code"></asp:Label> -->
                                </td>
                                <td width="10%" class="left_5" >
	        	...
	        	<table class="gridview" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;" id="list_table">
	            	<thead>
						<tr>
							...
							<th style="width:15"><div align="center"><spring:message code="SM02.CodeGrp"/></div></th>
							<th style="width:10%"><div align="center"><spring:message code="SM02.Code"/></div></th>
							<th style="width:35%"><div align="center"><spring:message code="SM02.CodeName"/></div></th>
							<th style="width:10%"><div align="center"><spring:message code="SM02.CodeValue"/></div></th>
