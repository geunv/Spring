...
if('U' == '<%=user_grade%>'){
    ...
    $(document).ready(function() {
		...
		$('#ddlSystemArea').on('change', function(){
    		$('#btnSearch').click()
    	});
		
		$('#ddlLangType').on('change', function(){
    		$('#btnSearch').click()
    	});

		$("#txtLangID").keydown(function (key) {
    ...
    function getList(){
    	...
    	$.get('/api/system/getlanguagelist'+params,function(data){
    		if(data.result == 200){
    			...
    			data.list.forEach(function(item){
    				...
    				$('#list_data').append(
    					   '<tr>'
							+ ' <td>' + item.rnum +'</td>'
							+ ' <td class="left_5"><a href=\'#\' onClick="OpenRegistration(\'' + item.msg_id.trim() +'\',\''+item.data_type.trim() +'\');">' + item.msg_id              + '</a></td>'
							+ ' <td>' + var_type +'</td>'
							+ ' <td>' + var_system +'</td>'
							+ ' <td class="left_5">' + item.msg_text_ko_kr +'</td>'
							+ ' <td class="left_5">' + item.msg_text_en_us +'</td>'
							+ ' <td class="left_5">' + item.msg_text_lo_ln +'</td>'
    ...
    function getExcelData(){
    	...
    	$.ajax({
    			url:'/api/system/getlanguagelist'+params,
    			type:'GET',
    			async:false,
    			success: function(data) {
    				if(data.result == 200){
    					...
    					$("#list_excel").append("<th><spring:message code='SM03.LangID'/></th>");
						$("#list_excel").append("<th><spring:message code='SM03.LangType'/></th>");
						$("#list_excel").append("<th><spring:message code='SM03.SysArea'/></th>");
    					$("#list_excel").append("<th><spring:message code='SM03.LangKor'/></th>");
    					$("#list_excel").append("<th><spring:message code='SM03.LangEng'/></th>");
    					$("#list_excel").append("<th><spring:message code='SM03.LangLon'/></th>");
    					...
    					data.list.forEach(function(item){
    	    				...
    	    				$('#list_excel').append(
    								...
    								+ ' <td>' + item.sys_area +'</td>'
    								+ ' <td>' + item.msg_text_ko_kr +'</td>'
    								+ ' <td>' + item.msg_text_en_us +'</td>'
    								+ ' <td>' + item.msg_text_lo_ln +'</td>'
    								+ ' <td>' + ChangeDateFormat(item.regdt) +'</td>'
    								+ ' <td>' + item.reg_user_id +'</td>'
    	    					+ '</tr>'
    	    				);
    ...
    function OpenRegistration(LangID, LangType) {
    	var title = '<spring:message code="SCREEN.SM03" />';
        fn_ShowDialog('/view/system/languageP01.aspx?lang_id=' + LangID +'&lang_type=' + LangType, title, '500', '420', true);
    }
	...
	<div id="C_Body">       
        <div id="C_Title">
            <div id="content-title">
                <i class="fa fa-pencil-square-o "></i> <spring:message code="SCREEN.SM03" /><!-- <asp:Label ID="lblTitle" runat="server" Text="SCREEN.SM03"></asp:Label> -->
            </div>
            <div id="content-title-nav">
                <i class="fa fa-angle-double-right"></i> <spring:message code="MENU.SYSTEM" /><!-- <asp:Label ID="lblMenuSystem" runat="server" Text="MENU.SYSTEM"></asp:Label> -->
            </div>
                    ...
                    <td>
                        <table width="100%">
                            <tr>
                                ...
                                <td  width="9%" bgcolor="#FFFFFF" class="left_5">
                                    <i class="fa fa-chevron-circle-right"></i>&nbsp; <spring:message code="SM03.SysArea" /><!-- <asp:Label ID="lblSysArea" runat="server" Text="SM03.SysArea"></asp:Label> -->
                                </td>
                                <td width="10%" class="left_5">
                                	<select id="ddlSystemArea"></select>
                                    <!-- <asp:DropDownList ID="ddlSystemArea" runat="server" AutoPostBack="true"
                                        onselectedindexchanged="ddlSystemArea_SelectedIndexChanged"></asp:DropDownList> -->
                                </td>
                                <td  width="10%" bgcolor="#FFFFFF" class="left_5">
                                    <i class="fa fa-chevron-circle-right"></i>&nbsp; <spring:message code="SM03.LangType" /><!-- <asp:Label ID="lblLangType" runat="server" Text="SM03.LangType" ></asp:Label> -->
                                </td>
                                <td width="10%" class="left_5">
                                	<select id="ddlLangType"></select>
                                    <!-- <asp:DropDownList ID="ddlLangType" runat="server" AutoPostBack="true"
                                        onselectedindexchanged="ddlLangType_SelectedIndexChanged"></asp:DropDownList> -->
                                </td>
                                <td width="9%" bgcolor="#FFFFFF" class="left_5">
                                    <i class="fa fa-chevron-circle-right"></i>&nbsp; <spring:message code="SM03.LangID" /><!-- <asp:Label ID="lblLangID" runat="server" Text="SM03.LangID"></asp:Label> -->
                                </td>
                                <td width="10%" class="left_5">
                                	<input type="text" id="txtLangID">
                                    <!-- <asp:TextBox ID="txtLangID" runat="server" ></asp:TextBox> -->
                                 </td>
           ...
           <div class="total_count">
	        ...
	        <div >
	        	<table class="gridview" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;" id="list_table">
	            	<thead>
						<tr>
							<th style="width:3%"><div align="center"><spring:message code="COMMON.Num"/></div></th>
							<th style="width:12%"><div align="center"><spring:message code="SM03.LangID"/></div></th>
							<th style="width:10%"><div align="center"><spring:message code="SM03.LangType"/></div></th>
							<th style="width:8%"><div align="center"><spring:message code="SM03.SysArea"/></div></th>
							<th style="width:18%"><div align="center"><spring:message code="SM03.LangKor"/></div></th>
							<th style="width:18%"><div align="center"><spring:message code="SM03.LangEng"/></div></th>
							<th style="width:10%"><div align="center"><spring:message code="SM03.LangLon"/></div></th>
							<th style="width:13%"><div align="center"><spring:message code="COMMON.RegisterDate"/></div></th>
							<th style="width:8%"><div align="center"><spring:message code="COMMON.Register"/></div></th>
						</tr>
					</thead>
					<tbody id="list_data">
					</tbody>
